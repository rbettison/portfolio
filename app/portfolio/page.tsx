...
export default function Portfolio() {
    ...
    return(
        ...
        <Page 
                    ...
                    title="cv chatbot" 
                    description={<><p>a chatbot trained on my resumé built using Google&apos;s Dialogflow CX. Try it out in the bottom-right of the screen.</p></>} 
                    serviceNumber={1}
                    svgIcon={<svg 
                        className="h-10 w-10 m-5 absolute right-4"
